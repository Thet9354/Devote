...
//  DevoteWidget
//
//  Created by Phoon Thet Pine on 26/10/23.
//
...
struct DevoteWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .description("This is an example widgte for the personal task manager app.")
    }
}

struct DevoteWidget_Preview: PreviewProvider {
    static var previews: some View {
        Group {
            DevoteWidgetEntryView(entry: SimpleEntry(date: Date(), emoji: "grinning face"))
